...
/**
 * Controller manages the rendering of the feature pages throughout the
 * application.
 * 
 * @author annadowling
 */
public class Dashboard extends Controller {
	...
	/**
	 * Retrieves activity values from the form and creates the activity from
	 * these values. Activity is then added to the currentUsers list of
	 * activities.
	 * 
	...
	/**
	 * Retrieves location values from the form and creates the location from
	 * these values. Location is then added to the currently selected activity
	 * as a route.
	 * 
	 * @return Result redirect to activity dashboard
	 */
	...
	/**
	 * Retrieves all users currently registered. Renders the list of users to
	 * the show users page
	 * 
	 * @return Result
	 */
	...
	/**
	 * Retrieves all users currently registered. Adds an entry for the
	 * currentUser and the selected friend to the Friends model using the
	 * FriendUtils method: followFriend().
	 * 
	 * @param friendId
	...
	/**
	 * Retrieves all pending friend requests for the logged in user using
	 * FriendUtils.getAllPendingFollowRequests() Renders this list of users to
	 * the follow requests page.
	 * 
	 * @return Result
	 */
	...
	/**
	 * Accepts the selected follow request for the currently logged in user
	 * using FriendUtils.acceptFollowRequest().
	 * 
	 * @param friendId
	 * @return Result
	 */
	...
	/**
	 * Renders the friends list for the currently logged in user using
	 * FriendUtils.showfriends().
	 * 
	 * @return Result
	 */
	...
	/**
	 * Renders the public profile of friends for the currently logged in user
	 * using FriendUtils.findUserByfriendId().
	 * 
	 * @param friendId
	 * @return Result
	 */
	...
	/**
	 * Renders the activity management page with a list of current users
	 * activities.
	 * 
	 * @return Result
	 */
	...
	/**
	 * Renders the location management page with a list of current users
	 * activities routes.
	 * 
	 * @return Result
	 */
