...
/**
 * Controller used for handling the deletion and updating of various model
 * properties for activity and location from form entries.
 * 
 * @author annadowling
 */
public class PropsController extends Controller {
	...
	/**
	 * Retrieves values from an activity form and determines whether to update
	 * the values for that activity.
	 * 
	 * @param activityId
	 * @return Result
	 */
	...
	/**
	 * Renders the manage activities page with a list of the current users
	 * activities.
	 * 
	 * @return Result
	 */
	...
	/**
	 * Retrieves values from a location form and determines whether to update
	 * the values for that location.
	 * 
	 * @param locationId
	 * @return Result
	 */
