...
/**
 * Controller used for generating activity reports filtered by various categories. 
 * @author annadowling
 *
 */
public class ReportController extends Controller{
	...
	public Result renderActivityReportPage()
	 ...
	 /**
		 * Render Activity report view containing a list of all user activities filtered by date.
		 * Using method ActivityFilterService.filterActivityByDate()
		 * 
		 * @return Result
		 */
	...
	/**
	 * Render Activity report view containing a list of all user activities filtered by duration.
	 * Using method ActivityFilterService.filterActivityByDuration()
	 * 
	 * @return Result
	 */
	...
	/**
	 * Render Activity report view containing a list of all user activities filtered by distance.
	 * Using method ActivityFilterService.filterActivityByDistance()
	 * 
	 * @return Result
	 */
	...
	/**
	 * Render Activity report view containing a list of all user activities filtered by type.
	 * Using method ActivityFilterService.filterActivityByType()
	 * 
	 * @return Result
	 */
	...
	/**
	 * Render Activity report view containing a list of all user activities filtered by location.
	 * Using method ActivityFilterService.filterActivityByLocation()
	 * 
	 * @return Result
	 */
